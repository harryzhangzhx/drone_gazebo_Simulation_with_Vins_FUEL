...
extern int AscentCandidates;
extern int BackboneTrials;
extern int Backtracking;
extern GainType BestCost;
extern int* BestTour;
extern GainType BetterCost;
extern int* BetterTour;
extern int CacheMask;
extern int* CacheVal;
extern int* CacheSig;
extern int CandidateFiles;
extern int* CostMatrix;
extern int Dimension;
extern int DimensionSaved;
extern int EdgeFiles;
extern double Excess;
extern int ExtraCandidates;
extern Node *FirstActive, *LastActive;
extern Node* FirstNode;
extern Segment* FirstSegment;
extern SSegment* FirstSSegment;
extern int Gain23Used;
extern int GainCriterionUsed;
extern double GridSize;
extern int GroupSize;
extern int SGroupSize;
extern int Groups;
extern int SGroups;
extern unsigned Hash;
extern Node** Heap;
extern HashTable* HTable;
extern int InitialPeriod;
extern int InitialStepSize;
extern double InitialTourFraction;
...
extern int MaxCandidates;
extern int MaxMatrixDimension;
extern int MaxSwaps;
extern int MaxTrials;
extern int MergeTourFiles;
extern int MoveType;
extern Node* NodeSet;
extern int Norm;
extern int NonsequentialMoveType;
extern GainType Optimum;
extern int PatchingA;
extern int PatchingC;
extern int Precision;
extern int PredSucCostAvailable;
extern int POPMUSIC_InitialTour;
extern int POPMUSIC_MaxNeighbors;
extern int POPMUSIC_SampleSize;
extern int POPMUSIC_Solutions;
extern int POPMUSIC_Trials;
extern unsigned* Rand;
extern int Recombination;
extern int RestrictedSearch;
extern short Reversed;
extern int Run;
extern int Runs;
extern unsigned Seed;
extern int StopAtOptimum;
extern int Subgradient;
extern int SubproblemSize;
extern int SubsequentMoveType;
extern int SubsequentPatching;
extern SwapRecord* SwapStack;
extern int Swaps;
...
extern char *ParameterFileName, *ProblemFileName, *PiFileName, *TourFileName, *OutputTourFileName,
...
extern int CandidateSetSymmetric, CandidateSetType, CoordType, DelaunayPartitioning, DelaunayPure,
...
extern FILE *ParameterFile, *ProblemFile, *PiFile, *InputTourFile, *TourFile, *InitialTourFile,
