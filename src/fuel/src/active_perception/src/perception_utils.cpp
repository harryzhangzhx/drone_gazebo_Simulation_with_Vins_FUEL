...
PerceptionUtils::PerceptionUtils(const std::shared_ptr<rclcpp::Node>& nh) {
  
  nh->get_parameter("perception_utils/top_angle", top_angle_);

  nh->get_parameter("perception_utils/left_angle", left_angle_);

  nh->get_parameter("perception_utils/right_angle", right_angle_);

  nh->get_parameter("perception_utils/max_dist", max_dist_);

  nh->get_parameter("perception_utils/vis_dist", vis_dist_);
