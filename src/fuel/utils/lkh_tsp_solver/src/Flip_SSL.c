...
void Flip_SSL(Node *t1, Node *t2, Node *t3)
{
    ...
    else if ((P1 == P3 && abs(t3->Rank - t1->Rank) > SPLIT_CUTOFF * GroupSize) || (P2 == P4 && abs(t4->Rank - t2->Rank) >
    ...
    else
    {
        ...
        else if ((P1 == P3 && abs(t3->Rank - t1->Rank) > SPLIT_CUTOFF * SGroupSize) || (P2 == P4 && abs(t4->Rank - t2->Rank) >
