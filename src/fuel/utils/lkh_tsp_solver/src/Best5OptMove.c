                                 ...
                                 Nt8++)
                            {
                                ...
                                for (X10 = 1; X10 <= 2; X10++)
                                {
                                    if (X10 == 1)
                                    {
                                        ...
                                        {
                                        case 1:
                                            t10 = (BTW275 ? BETWEEN(t8, t9, t5) || BETWEEN(t3, t9,
                                                                                           t1)
                                                   : BTW674
                                                       ? BETWEEN(t7, t9,
                                                                 t1)
                                            ...
                                            break;
                                        case 2:
                                            t10 = (BTW376 ? BETWEEN(t8, t9, t4) : BTW571 ? BETWEEN(t7, t9, t1) || BETWEEN(t3, t9, t6)
                                                                                         : BETWEEN(t7, t9, t1))
                                                      ? PRED(t9)
                                                      : SUC(t9);
                                            Case10 = 23;
                                        ...
                                        case 4:
                                            ...
                                            break;
                                        case 5:
                                            t10 = (BTW471 ? BETWEEN(t7, t9, t1) : BTW673 ? BETWEEN(t7, t9, t5)
                                            ...
                                            break;
                                        case 6:
                                            t10 = (BTW471 ? BETWEEN(t7, t9, t3) : BTW573 ? BETWEEN(t8, t9, t6)
                                    ...
                                    if (!Backtracking || Swaps > 0)
                                    {
                                            ...
                                            Swaps < MaxSwaps && Excludable(t9, t10) && !InInputTour(t9, t10))
                                        {
                                            ...
                                            if (RestrictedSearch &&
                                                ProblemType != HCP &&
                                                ProblemType != HPP &&
                                                G2 - t4->Pi == G4 - t6->Pi && G4 - t6->Pi == G6 - t8->Pi && G6 - t8->Pi == G8 - t10->Pi && G3 + t5->Pi == G1 + t3->Pi && G5 + t7->Pi == G3 + t5->Pi && G7 + t9->Pi == G5 + t7->Pi)
                                                continue;
                                            T3 = t3;
                                            T4 = t4;
                                            T5 = t5;
