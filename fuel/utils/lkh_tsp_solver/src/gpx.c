...
GainType gpx(int *solution_blue, int *solution_red, int *offspring)
{
    ...
    // Step 6.b: test unfeasible components using simplified l graphs
        ...
        for (i = 0; i < cand_rev; i++)
        {
            if (entries_flag_rev[i] == 0)
            {
                ...
                if (size_rev[i] < min_size_rev ||
                    (size_rev[i] == min_size_rev && n_entries_rev[i] == 2))
                {
            ...
            if (cand_mcuts > 0)
            {
                for (i = 0; i < n_new; i++)
                {
                    if (vector_comp[i] == -1)
                    {
                        ...
                        else if (red_chosen == 1 && assigned_rev[Tour_table[i][5]] !=
                                                        -1)
                        {
                            vector_comp[i] =
