...
# Terminal 1: PX4 SITL
gnome-terminal -- bash -c "export DISPLAY=:0; sleep 2; cd ~/PX4-Autopilot && PX4_GZ_WORLD=baylands make px4_sitl gz_x500_depth; exec bash" # if using the house model, change to "PX4_GZ_WORLD=singleHouseWorld"
