...
namespace camodocal
{
    ...
    public:
        ...
        ReprojectionError3(const std::vector<double> &intrinsic_params,
                           ...
                           const Eigen::Vector3d &odo_att,
                           const Eigen::Vector2d &observed_p)
            : m_intrinsic_params(intrinsic_params), m_cam_odo_q(cam_odo_q), m_cam_odo_t(cam_odo_t), m_odo_pos(odo_pos), m_odo_att(odo_att), m_observed_p(observed_p), m_optimize_cam_odo_z(true)
        {
        }
                                              ...
                                              const Eigen::Vector2d &observed_p_r) const
    {
        ...
        case Camera::MEI:
            ...
            break;
        case Camera::SCARAMUZZA:
            costFunction = new ceres::AutoDiffCostFunction<StereoReprojectionError<OCAMCamera>, 4, SCARAMUZZA_CAMERA_NUM_PARAMS, SCARAMUZZA_CAMERA_NUM_PARAMS, 4, 3, 4, 3>(
